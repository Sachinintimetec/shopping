    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Andman & Nicobar', 'Andman & Nicobar'), ('Assam', 'Assam'), ('Bihar', 'Bihar'), ('Rajasthan', 'Rajasthan'), ('Up', 'Up'), ('Punjab', 'Punjab'), ('Nagaland', 'Nagaland')], max_length=50)),
